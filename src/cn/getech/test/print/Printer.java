...
public class Printer {
    ...
    public static void main(String[] args) {
        //Printer p = new Printer("\\\\LENOVO-PC\\ZDesigner 105SL 203DPI");
        Printer p = new Printer("ZDesigner GT800 (EPL)");
        //1.打印单个条码  条码内容
        String bar0 = "1234567890";
        //http://www.doc88.com/p-3324682614304.html
        String bar0Zpl = "^FO110,110^BY6,3.0,280^BCN,,Y,N,N^FD${data}^FS";//条码样式模板
        //content += bar0Zpl.replace("${data}", bar0);
     ...
     */
    public Printer(String printerURI){
